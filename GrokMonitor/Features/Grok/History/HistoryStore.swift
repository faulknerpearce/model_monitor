...
final class HistoryStore: ObservableObject {
    ...
    /// `~/Library/Application Support/GrokMonitor/`. Without this migration the
    ...
    private static func migrateLegacyStoreIfNeeded(to storeURL: URL, applicationSupportBase base: URL) {
        ...
        let flagKey = "didMigrateGrokMonitorHistoryFromSandboxV2"

        let legacyCandidates: [URL] = [
            // Sandboxed Grok Monitor (primary source after disabling App Sandbox)
